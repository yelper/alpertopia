...
What follows is a write-up of how we adapted the conference to go online.  We'll describe the high-level goals, then describe the technical challenges and the way we addressed them.

The IEEE VIS Web team for 2020 was comprised of [Alper Sarikaya](https://alper.datav.is/), [Jagoda Walny](http://research.jagoda.ca/), and [Steve Spetruzza](https://www.sci.utah.edu/people/spetruzza.html), with much assistance by [Hendrik Strobelt](http://hendrik.strobelt.com/) (as Archive chair) and [Will Usher](https://www.willusher.io/) (as Tech chair), and input from [the rest of the organizing committee](http://ieeevis.org/year/2020/info/committees/conference-committee).
...
Due to our relative inexperience in constructing virtual communities from scratch (we're academics, after all!), the following eventually became non-goals for the website *but should not be ignored for virtual conferences*.  We ended up resolving these in different ways outside of the website (see "Reflections" at the bottom of this post):
...
At this time, we also stopped the authentication Python script and destroyed the registered users list.
...
**Cost:** Running all these various AWS services (~15 S3 buckets, 4 Cloudfront hosts, many Route 53 routes, and certs) cost on the order of $40 / month.
