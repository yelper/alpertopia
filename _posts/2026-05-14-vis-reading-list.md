...
date: 2026-05-14 23:00:00 -0700
categories: vis
teaser: reading-teaser.png
excerpt: "Capturing the historical context and current state-of-the-art of the discipline"
---

Here's an initial data visualization reading (and watching?!) list.  As we talk about topics during the reading, this list and the topics will likely grow!  To keep track, I've added a [changelog](#changelog) at the bottom.

### Table of Contents
* [Why visualization?](#why-visualization)
* [Data and task abstraction](#data-and-task-abstraction)
* [Critique and Re-design](#critique-and-re-design)
* [Tools for Visualization](#tools-for-visualization)
* [Graphics and Perception](#graphics-and-perception)
* [Accessible, augmented, and alternative interfaces](#accessible-augmented-and-alternative-interfaces)
* [Literacy and education](#literacy-and-education)
* _[Changelog](#changelog)_
...
A common reference for what "data visualization" is, though this explanation leans more toward berevity instead of completeness. The [/r/dataisbeautiful subreddit](https://old.reddit.com/r/dataisbeautiful/) uses this [as its standard](https://old.reddit.com/r/dataisbeautiful/wiki/rules/rule1) for acceptable data visualization submissions.
...
**Alberto Cairo:** How should statisticians, journalists, and designers reveal uncertainty in graphics for public consumption? <https://ovastgacct.blob.core.windows.net/ovamedia/course_materials/Uncertainty_and_graphicacy.pdf>

We've been lucky to have Alberto give a lecture (in person!) to us before to the Power BI group (but I think it was like 2018 or so)!  This article is a great narrative about how charts can unintentionally lie or mislead, and what steps visualizations authors must take to ensure that those charts are not misread and are memorable.

## Data and task abstraction

Data and task abstraction is the academic attempt to abstract lessons from specific visualization representations to re-usable tenents applicable across data domains, characteristics, audiences, and types of representation.  The core idea is that by understanding the efficacy of how people interact with some representation, that knowledge can also be applied to a different visualization&mdash;with potentially a different audience, type of data, or data features&mdash;with similar resulting understanding by visualization viewers.<br><br>
...
A fun idea we played with is making a interactive "map" of the space with some examples, try it out! <https://alper.datav.is/scattertasks/>
...
TBD (articles on backburner!)

## Literacy and education
TBD (articles on backburner!)

## Changelog
* 14 May 2026: initial public release!